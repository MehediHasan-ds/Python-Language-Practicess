...
def email_generator(email_type):
    ...
    if email_type == "promotional":
        return promotional_email #first/higher class function use
    elif email_type == "transactional":
        return transactional_email #first/higher class function use
    else:
...
#DECORATORS: adding other functionalities to existing functions
